...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.pic_pattern'
        db.alter_column(u'ebets_player', 'pic_pattern', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding field 'Team.logo_pattern'
        db.add_column(u'ebets_team', 'logo_pattern',
                      self.gf('django.db.models.fields.CharField')(default='%s_team_logo_%dx%d', max_length=255),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Player.pic_pattern'
        db.alter_column(u'ebets_player', 'pic_pattern', self.gf('django.db.models.fields.CharField')(max_length=1024))
